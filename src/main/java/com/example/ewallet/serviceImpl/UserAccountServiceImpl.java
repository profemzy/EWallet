...
public class UserAccountServiceImpl implements UserAccountService {
    ...
    @Override
    public UserAccount userAccountByPK(Long userAccountId) throws Exception {
        return userAccountRepository.findById(userAccountId).
                orElseThrow(() -> new Exception(String.format("userAccount with '%d' not found ", userAccountId)));
    }
    ...
    /**
     * this operation updates a users userAccount information
